...
channel_ids = {'5 min TJ': 'UCTkn7SuQfrSIvTs8DR1TuZw'}  
...
async def create_webhook(title, link, youtube_name, date):
    async with aiohttp.ClientSession() as session:
        ...
        discord_webhook_url = https://discord.com/api/webhooks/1400670049148207194/QA0HcirgEBHmtlBiassvgs5HF37cdoOBeJWMc-NJ9vSBMdyDiQc_as9bn_5jM8FmICUZ
        ...
        webhook_username = TJ_youtube # enter name of the Webhook user, can be anything (in this case, it's YouTube Bot)
        webhook_avatar = "https://imgur.com/a/5l3o7k5" # enter a url to a pic if you want a avatar
    ...
    while True:
        for chan_id in channel_ids:
            async with aiohttp.ClientSession() as session:
                ...
                async with session.get(f"https://www.youtube.com/feeds/videos.xml?channel_id={UCTkn7SuQfrSIvTs8DR1TuZw[UCTkn7SuQfrSIvTs8DR1TuZw]}", headers=HEADERS) as r:
